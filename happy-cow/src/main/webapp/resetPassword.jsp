...
<head>
    <meta charset="UTF-8">
    <title>Reset Password - HappyCow Dairy</title>
    ...
    <style>
        ...
        body {
            padding-top: 80px; /* Adjust height to match navbar */
        }
    </style>
</head>
<body>
...
<!-- ✅ Reset Section -->
<section id="reset-section" class="py-5 bg-light" style="min-height: calc(100vh - 160px); display: flex; align-items: center;">
    <div class="container">
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-5">
                        <h2 class="text-center mb-4 fw-bold text-success">
                            <i class="fa-solid fa-unlock-keyhole me-2"></i> Reset Password
                        </h2>
