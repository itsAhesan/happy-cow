...
<head>
    <meta charset="UTF-8">
    <title>Register Product - HappyCow Dairy</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <a href="productDashboard" class="active"><i class="fa-solid fa-cow me-2"></i> Products</a>
        ...
        <div class="col-md-10 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold text-success mb-0">
                    <i class="fa-solid fa-box-open me-2"></i> Register Product
                </h2>
    ...
    $("#productForm").validate({
        rules: {
            productName: {
                ...
                maxlength: 100,
                remote: {
                    url: "registerProduct/checkProductName",   // maps to backend endpoint
                    type: "get",
                    data: {
                        productName: function () {
                            return $("#productForm input[name='productName']").val();
                        }
                    }
                }
            },
        ...
        messages: {
            ...
            productPrice: {
                ...
                max: "Price should not exceed 10000"
            },
            productType: {
