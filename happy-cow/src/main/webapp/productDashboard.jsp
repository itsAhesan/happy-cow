...
<head>
    <meta charset="UTF-8">
    <title>Product Dashboard - HappyCow Dairy</title>
    ...
    <div class="row">
        ...
        <div class="col-md-10 py-4">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <form class="row g-2 align-items-center search-box" action="productDashboard" method="get">
                        <div class="col-sm-10">
                    ...
                    <c:if test="${not empty param.search}">
                        <p class="text-muted small mt-2 mb-0">
                            ...
                            <a href="productDashboard" class="ms-2 text-decoration-none">
            ...
            <c:if test="${empty products}">
                <div class="alert alert-info text-center mt-4">
                    ...
                    No products found. Click <strong>"Add New Product"</strong> to add one.
                </div>
            </c:if>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    deleteModal.addEventListener("show.bs.modal", function (event) {
        ...
        confirmBtn.href = "deleteProduct?id=" + productId;
    });
});
</script>
